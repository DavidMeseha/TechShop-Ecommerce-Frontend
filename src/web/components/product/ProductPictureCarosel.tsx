...
import { Carousel, CarouselApi, CarouselContent, CarouselItem } from "@/common/components/ui/carousel";
import CarouselIndecator from "@/common/components/ui/CarouselIndecator";
...
export default function ProductPictureCarosel({ images, productName, height }: Props) {
