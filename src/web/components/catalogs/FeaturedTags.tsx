...
import { FEATURED_QUERY_KEY, TAGS_QUERY_KEY } from "@/common/constants/query-keys";
...
export function FeaturedTags() {
  ...
  return (
    <Carousel className="w-full px-10" dir="ltr" opts={{ align: "start" }} ref={ref}>
      ...
      <CarouselPrevious className="start-0 p-2" variant="default" />
      <CarouselNext className="end-0 p-2" variant="default" />
    </Carousel>
  );
}
